...
//     if (*mode == 3) {
//       for (l1 = 0; l1 < pointCount; l1++) {
//         deltaArray[l1] = points[activeFunction]->point(l1).x() - FUNCTION_CENTER_X;
//       }
//     } else if (*mode == 4) {
//       for (l1 = 0; l1 < pointCount; l1++) {
//         deltaArray[l1] = points[activeFunction]->point(l1).y() - FUNCTION_CENTER_Y;
//       }
//     }                                                                      
//   } else {
//     activePoint = -1;
